...
checkpoint_path = "modelcheckpoint_weights_Densenet_feature+finetune/checkpoint.ckpt"
...
history_resnet = model.fit(train_data,
                        ...
                        validation_steps = len(test_data),
                         callbacks = [create_tensorboard_callback(dir_name = "DenseNet201",
...
TP = history_resnet.history['val_true_positives_1'][-1]
TN = history_resnet.history['val_true_negatives_1'][-1]
FP = history_resnet.history['val_false_positives_1'][-1]
FN = history_resnet.history['val_false_negatives_1'][-1]
...
# Get the values from the history object
TP = history_2.history['val_true_positives_2'][-1]
TN = history_2.history['val_true_negatives_2'][-1]
FP = history_2.history['val_false_positives_2'][-1]
FN = history_2.history['val_false_negatives_2'][-1]
...
model.save('DenseNet201-Featureextract_Finetune-model1')

test_accuracy = history_2.history['val_binary_accuracy'][-1]
test_loss = history_2.history['val_loss'][-1]
test_io_u = history_2.history['val_binary_io_u_2'][-1]

with open('test_metrics_DenseNet201.txt', 'w') as f:

...
checkpoint_path = "modelcheckpoint_weights_VGG19_feature+finetune/checkpoint.ckpt"
...
history_resnet = model.fit(train_data,
                        ...
                        validation_steps = len(test_data),
                         callbacks = [create_tensorboard_callback(dir_name = "VGG19",
...
model.save('VGG19-Featureextract_Finetune-model1')
...
with open('test_metrics_vgg.txt', 'w') as f:
